...
namespace TakeLessons
{
    public partial class FrmLoading : Form
    {
        ...
        private delegate void SetMsgCallback(string msg);
        /// <summary>
        /// 设置加载窗文字
        /// </summary>
        /// <param name="msg">需要设置的内容</param>
        public void SetMessage(string msg)
        {
            if (LblMessage.InvokeRequired)
            {
                SetMsgCallback setMsgCallback = new SetMsgCallback(SetMessage);
                Invoke(setMsgCallback, new object[] { msg });
            }
            else
            {
                LblMessage.Text = msg;
